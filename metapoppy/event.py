...
class Event(object):
    ...
    def __init__(self, reaction_parameter_key, additional_parameter_keys=None):
        ...
        self._parameters = {reaction_parameter_key: 0.0}
    ...
    def calculate_rate_at_patch(self, network, patch_id):
        return self._parameters[self._reaction_parameter_key] * \
               self._calculate_state_variable_at_patch(network, patch_id)
