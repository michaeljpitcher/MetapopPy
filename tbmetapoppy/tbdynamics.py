...
class TBDynamics(Dynamics):
    ...
    def _create_events(self):
        ...
        bed_translocation = TranslocationLymphToLung(TBPulmonaryEnvironment.BACTERIUM_EXTRACELLULAR_DORMANT)
    ...
    def setUp(self, params):
        ...
        def drop_rec_rate():
            current_rate_mr_lung = self._parameters[self._lung_recruit_keys[TBPulmonaryEnvironment.MACROPHAGE_RESTING]]
            ...
            current_rate_mr_lymph = self._parameters[self._lymph_recruit_keys[TBPulmonaryEnvironment.MACROPHAGE_RESTING]]
            ...
            current_rate_di_lung = self._parameters[self._lung_recruit_keys[TBPulmonaryEnvironment.DENDRITIC_CELL_IMMATURE]]
            ...
            current_rate_tn_lymph = self._parameters[self._lymph_recruit_keys[TBPulmonaryEnvironment.T_CELL_NAIVE]]
